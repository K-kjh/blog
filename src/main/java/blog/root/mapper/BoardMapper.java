...
public interface BoardMapper {
	...
	public int boardUpdate(@Param("board_contents")String board_contents,@Param("board_title")String board_title,@Param("board_type")int board_type,@Param("board_number")int board_number,@Param("user_number")int user_number) throws Exception;
	//게시판 업데이트
	...
	public int Board_create(@Param("board_title") String board_title,@Param("board_type")int board_type,@Param("board_contents")String board_contents,@Param("user_number")int user_number);
	//게시물 등록 하는 컬럼 
